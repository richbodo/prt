...
class PRTCLI:
    ...
    def enter_chat_mode(self):
        """Enter AI chat mode with Ollama integration."""
        from .llm_ollama import start_ollama_chat
        
        console.print("\n🤖 Ollama LLM Chat Mode", style="bold blue")
        console.print("Starting chat with GPT-OSS-20B...", style="cyan")
        
        try:
            start_ollama_chat(self.api)
