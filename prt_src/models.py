...
class Note(Base):
    ...
    relationships = relationship(
        "Relationship", secondary="relationship_notes", back_populates="notes"
    )
...
class Relationship(Base):
    ...
    notes = relationship(
        "Note", secondary="relationship_notes", back_populates="relationships"
    )
...
relationship_tags = Table(
    ...
    Base.metadata,
    Column(
        "relationship_id", Integer, ForeignKey("relationships.id"), primary_key=True
    ),
