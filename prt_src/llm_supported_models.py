...
SUPPORTED_MODELS: Dict[str, SupportedModelInfo] = {
    ...
    "mistral:7b-instruct": SupportedModelInfo(
        ...
        parameter_count="7B",
        context_size=8192,
        description="Efficient 7B instruction-tuned model with good performance",
        use_cases=["General chat", "Contact queries", "Moderate hardware"],
        notes="Good alternative for systems with limited RAM. Fast inference.",
    ),
