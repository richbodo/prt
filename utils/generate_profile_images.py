...
def generate_profile_images():
    ...
    john_img = create_gradient_image(
        (70, 130, 180), (30, 60, 100)
    )  # Steel blue gradient
    ...
    jane_img = create_initials_image(
        "JS", (220, 20, 60), (255, 255, 255)
    )  # Crimson with white text
    ...
    bob_img = create_geometric_image(
        (34, 139, 34), (255, 215, 0)
    )  # Forest green with gold circle
    ...
    alice_img = create_gradient_image(
        (138, 43, 226), (75, 0, 130)
    )  # Blue violet to indigo
    ...
    charlie_img = create_initials_image(
        "CB", (255, 140, 0), (255, 255, 255)
    )  # Dark orange with white text
    ...
    diana_img = create_gradient_image(
        (0, 128, 128), (72, 209, 204)
    )  # Teal to medium turquoise
